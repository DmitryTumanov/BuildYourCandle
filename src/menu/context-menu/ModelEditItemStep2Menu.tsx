...
import {changeEditingIndex} from "../../store/builderSlice";
import {updatePage} from "../../store/navigationSlice";
import DoneIcon from '@mui/icons-material/Done';
import CloseIcon from '@mui/icons-material/Close';


function ModelEditItemStep2Menu() {
    const dispatch = useAppDispatch();
    const navigation = useAppSelector(getNavigationState);

    if (navigation.currentPage !== ITEM_CREATION_STAGE_2_PAGE) {
        return null;
    }
...
export default ModelEditItemStep2Menu;
